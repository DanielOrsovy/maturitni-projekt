...
// COMIC PAGE SETTINGS
const folder = "obrazky/komiks"; //directory of the folder where you keep all the comics
...
const navFolder = "obrazky/comicnav"; //directory where nav images are stored
...
const pgData = [
    {
        ...
        title: "Psychoza", //the title of the page (leaving this blank will default it to "Page X")
